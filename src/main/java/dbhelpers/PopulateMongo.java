...
public class PopulateMongo {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        Auction auction7 = new Auction(7, "POLLING WORKS BRO", "A really really mean toothbrush bro, this shit is da bomb", "A really really mean toothbrush bro, this shit is da bomb", "/assets/tele.jpg", "https://google.com", 400, 395, 1, new Date());
        Auction auction8 = new Auction(8, "Hey James, You're Cool", "A really really mean toothbrush bro, this shit is da bomb", "A really really mean toothbrush bro, this shit is da bomb", "/assets/tele.jpg", "https://google.com", 400, 395, 1, new Date());
        Auction auction1 = new Auction(1, "Mean Television", "A really really mean television bro, this shit is da bomb", "A really really mean television bro, this shit is da bomb", "/assets/tele.jpg", "https://google.com", 400, 395, 1, new Date());
        Auction auction2 = new Auction(2, "Mean Car", "A really really mean car bro, this shit is da bomb", "A really really mean television bro, this shit is da bomb", "/assets/tele.jpg", "https://google.com", 400, 395, 1, new Date());
